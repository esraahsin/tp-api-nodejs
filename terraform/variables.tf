...
variable "public_key_path" {
  ...
  type        = string
  default     = "C:/Users/essra/.ssh/tp-api-keypair.pub"
}
...
variable "private_key_path" {
  ...
  type        = string
  default     = "C:/Users/essra/.ssh/tp-api-keypair"
}
...
variable "my_ip" {
  description = "102.171.238.164/32"
  type        = string
  # Pas de valeur par défaut — à mettre dans terraform.tfvars
}